...
const variantMap: { [key: number]: new (container: HTMLDivElement) => ImageTrailVariant1 | ImageTrailVariant2 | ImageTrailVariant3 | ImageTrailVariant4 | ImageTrailVariant5 | ImageTrailVariant6 | ImageTrailVariant7 | ImageTrailVariant8 } = {
...
export default function ImageTrail({
  ...
  return (
    ...
    >
      {items.map((url, i) => (
        <div
          className="w-[190px] aspect-[1.1] rounded-[15px] absolute top-0 left-0 opacity-0 overflow-hidden content__img"
          key={i}
        >
          <div
            className="content__img-inner w-full h-full bg-cover bg-center"
            style={{ 
